    ...
    <section class="content">
        ...
        <div class="col-md-12">
            <div class="box box-default">
                <!-- form start -->
                <form enctype="multipart/form-data" class="box-header form-horizontal" method="post" action="@if(isset($info)){{ route('admin.ks.oc.update',$info->id) }}@else{{ route('admin.ks.oc.store') }}@endif">
                    {{csrf_field()}}
