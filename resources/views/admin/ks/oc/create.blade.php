    ...
    <section class="content">
        ...
        <div class="col-md-12">
            <div class="box box-default">
                <!-- form start -->
                <form id="form" enctype="multipart/form-data" class="box-header form-horizontal" method="post" action="@if(isset($info)){{ route('admin.ks.oc.update',$info->id) }}@else{{ route('admin.ks.oc.store') }}@endif">
                    {{csrf_field()}}
                    ...
                    <div class="box-footer  ">
                        <a href="{{route('admin.ks.oc.index')}}" class="btn btn-default">返回</a>
