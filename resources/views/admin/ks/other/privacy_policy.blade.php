                ...
                <form enctype="multipart/form-data" class="box-header form-horizontal" method="post" action="{{route('admin.ks.other.privacy_policy_update')}}">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <textarea name="privacy_policy" style="width: 100%; height: 600px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" id="editor">{{$content}}</textarea>
                            </div>
                        </div>
