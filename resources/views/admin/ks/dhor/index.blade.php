            ...
            <div class="col-xs-12">
                <div class="box">
                    ...
                    <div class="box-header">
                        <div class="row">
                            @if(Auth::user()->can('admin.ks.dhor.create'))
                                <div class="col-lg-2 col-xs-2 pull-right">
                                    <a href="{{route('admin.ks.dhor.create')}}" class="btn btn-primary">新增</a>
                                </div>
                            @endif
                                ...
                                @foreach($infos as $k=>$info)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a class=" op_show" href="{{route('admin.ks.dhor.show',$info->r_id)}}"
                    ...
                    <div class="box-footer ">
                        @if(Auth::user()->can('admin.ks.dhor.batch_destroy'))
                            <div class="btn-group">
...
@section('js')
    ...
    <script>
        ...
        //有查看权限，显示查看
        @if(Auth::user()->can('admin.ks.dhor.show'))
             $(".op_show").show();
        @endif

        //有修改权限，显示修改
        @if(Auth::user()->can('admin.ks.dhor.edit'))
            $(".op_edit").show();
        @endif
        //有删除权限，显示删除
        @if(Auth::user()->can('admin.ks.dhor.destroy'))
            $(".op_destroy").show();
        @endif
        ...
        function batch_destroy() {
            ...
            if ($cbs.length > 0) {
                layer.confirm('确认删除？', {
                    ...
                    $.ajax({
                        url: '{{route("admin.ks.dhor.batch_destroy")}}',
                        type: 'post',
                        data: $("#ids").serialize(),
