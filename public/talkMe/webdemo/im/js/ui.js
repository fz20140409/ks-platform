    ...
    makeChatContent: function (message, user) {
        ...
        if (message.attach && message.attach.type && (message.attach.netcallType === undefined || (message.attach.type !== "netcallBill" && message.attach.type !== "netcallMiss"))) {
            ...
            var type = message.type,
                ...
                msgHtml;
                nick=""
                if(localStorage.getItem(message.from)){
                	var obj=JSON.parse(localStorage.getItem(message.from))
                	nick=obj.username
                	headImg=obj.uicon
                }else{
            ...
            if (type === "tip") {
                ...
                '<img class="img j-img" src="' + headImg + '" data-account="' + from + '"/>',
                showNick ? '<p class="nick">' + nick + '</p>' : '',
